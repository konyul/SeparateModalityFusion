work_dir=work_dirs/masking_strategy/version1/mask_l_defaultm_deform_attn_imgheads_sum
bash tools/dist_train.sh projects/BEVFusion/configs/bevfusion_lidar-cam_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d_deform_with_imghead_mask.py 4 --work-dir $work_dir
