# work_dir=work_dirs/masking_strategy/version2/image_head_robusthead_sum
...
# work_dir=work_dirs/masking_strategy/version2/image_head_robusthead_sum_smt
...
work_dir=work_dirs/masking_strategy/version2/image_head_robusthead_hybrid_query
for failures in 'lidar_drop1' 'lidar_drop2' 'lidar_drop3' 'lidar_drop4' 'lidar_drop5' 
do
    python3 tools/test.py projects/BEVFusion/configs/deform_failure_with_imghead/bevfusion_lidar-cam_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d_$failures.py pretrained/image_head_robusthead_smt.pth --work-dir $work_dir/$failures
done